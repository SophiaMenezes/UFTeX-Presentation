...
\begin{itemize}
\item Aqui possui o suficiente para uma introdução! Para acessar o código, acesse \href{https://github.com/SophiaMenezes/UFTeX-Presentation}{\beamergotobutton{Link do GitHub}}
\end{itemize}
\end{frame}
